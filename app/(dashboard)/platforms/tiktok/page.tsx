...
export default function TikTokDashboardPage() {
  ...
  const tableSortedPosts = useMemo(() => {
    ...
    <>
      ...
      <div className="mb-6 grid grid-cols-2 gap-4 md:grid-cols-4">
        ...
        <KPICard label="Engagements" value={formatCompact(data.summary.totalLikes + data.summary.totalComments + data.summary.totalShares)} subtitle={rangeLabel}
          trend={data.summary.comparison?.engagements != null ? { value: data.summary.comparison.engagements, isPositive: data.summary.comparison.engagements >= 0 } : undefined} />
        <KPICard label="Total Videos" value={String(data.summary.totalPosts)} subtitle={rangeLabel}
          ...
          <table className="w-full text-left text-xs">
            <thead>
              <tr className="border-b border-gray-100 text-clutch-grey/50">
                ...
                <SortHeader label="Shares" sortField="shares" align="right" />
