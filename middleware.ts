...
export const config = {
  matcher: [
    ...
    "/((?!api/auth|api/health|api/thumb|api/sync/trigger|api/sync/ingest|api/sync/ig-missing-data|_next/static|_next/image|favicon\\.ico|.*\\.(?:png|jpg|jpeg|gif|svg|webp|ico|woff|woff2|ttf)$).*)",
  ],
};
